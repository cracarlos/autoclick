; Script Inno Setup para AutoClick
; Compilar con: ISCC installer\AutoClick.iss

#define MyAppName "AutoClick"
#define MyAppVersion "1.0.0"
#define MyAppPublisher "AutoClick"
#define MyAppExeName "AutoClick.exe"
#define MyAppExePath "..\dist\AutoClick.exe"

[Setup]
AppId={{8F4C0A0E-7E2A-4B1B-9D0E-3A6B5C2F1D01}
AppName={#MyAppName}
